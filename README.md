...
```html
<link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/fonts-archive/IntelOneMono/subsets/IntelOneMono-dynamic-subset.css" type="text/css"/>
```

### CSS

```css
@import url('https://cdn.jsdelivr.net/gh/fonts-archive/IntelOneMono/subsets/IntelOneMono-dynamic-subset.css');
```
